...
def solve(fn: str) -> None:
    ...
    # number of pairs of junction boxes to process - change this depending on input
    # 08_sample.txt - 10
    # 08_input.txt - 1000
    n = 1000

    # for each of the n closest pairs, combine the circuits
    for i in range(n):
        combine_circuits(i, circuits, box_to_circuit_index, distances[i])
    # print(circuits)

    # sort the circuits by their lengths (number of boxes)
...
def combine_circuits(i, circuits, box_to_circuit_index, d):
    a = d[1]
    b = d[2]
